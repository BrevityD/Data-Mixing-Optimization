...
#SBATCH --gres=gpu:8
#SBATCH --exclusive
#SBATCH --exclude=g42-h100-instance-066,g42-h100-instance-075,g42-h100-instance-078,g42-h100-instance-079,g42-h100-instance-087,g42-h100-instance-089,g42-h100-instance-165
...
for total_num in "${total_nums[@]}"; do
    for prop1 in "${prop1_values[@]}"; do
        ...
        max_steps=$(python -c "import math; print(math.ceil(${total_num}*3/32))")
