...
for seed in "${seeds[@]}"; do
    ...
    srun torchrun \
        ...
        --resume_from_checkpoint /mbz/users/liyuan/LLaMA-Factory/saves/data_mixing/orca/Llama-3.1-70B/submodular/Llama-3.1-70B_orca_submodular_1.0e-6_seed42/checkpoint-2300 \
        --warmup_ratio 0.05 \
        --bf16 \
        --ddp_timeout 180000 \
