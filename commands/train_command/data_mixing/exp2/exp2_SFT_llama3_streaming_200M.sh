...
for pair in "${size_pairs[@]}"; do
    read -r size1 size2 <<< "$pair"  # Split the pair into size1 and size2
        for size3 in "${sizes[@]}"; do
            ...
            if (( $(echo "$sum == 1" | bc -l) )); then
                ...
                for seed in "${seeds[@]}"; do
                    ...
                    output_dir="saves/data_mixing/exp2/${model_name}/${base_token}/${domain}/${model_name}_${dataset_instr}_${dataset_math}_${dataset_code}_${lr}_seed${seed}"
