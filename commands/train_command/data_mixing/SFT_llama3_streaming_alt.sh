...
for domain in "${domains_1[@]}"; do
    for size in "${sizes[@]}"; do
        ...
        for seed in "${seeds[@]}"; do
            ...
            output_dir="saves/data_mixing/exp1/${model_name}/${base_token}_5/${domain}/${model_name}_${dataset1}_${dataset2}_${dataset3}_${lr}_seed${seed}"
...
# TODO
# domain="code"
# dataset1="code_triple"
# dataset2="instr_one"
# dataset3="math_one"

# domain="math"
# dataset1="math_double"
# dataset2="instr_one"
# dataset3="code_one"
...
#     output_dir="saves/data_mixing/exp1/${model_name}/${base_token}/${domain}/${model_name}_${dataset1}_${dataset2}_${dataset3}_${lr}_seed${seed}"
