...
for seed in "${seeds[@]}"; do
    ...
    srun torchrun \
        ...
        --seed "${seed}" \
        --streaming True \
        --resume_from_checkpoint /mbz/users/liyuan/LLaMA-Factory/saves/data_mixing/tulu3/Llama-3.1-70B/submodular/Llama-3.1-70B_tulu3_submodular_1.0e-6_seed42/checkpoint-2550 \
        --max_steps 4000 \
