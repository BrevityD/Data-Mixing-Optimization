...
#SBATCH --gres=gpu:8
#SBATCH --exclude=g42-h100-instance-093
...
#           --model_name_or_path ${checkpoint_path}/${model_base}/${base_token}/${domain}/${model_base}_${dataset1}_${dataset2}_${dataset3}_${lr}_seed42 \
#           --save_name ${experiment_result}/${model_base}/${base_token}/${domain}/ppl_${model_base}_${dataset1}_${dataset2}_${dataset3}.json \
#           --batch_size 8 \
...
for domain in "${domains[@]}"; do
    for size in "${sizes[@]}"; do
        ...
        for eval_dataset in "${eval_datasets[@]}"; do 
            torchrun /mbz/users/liyuan/LLaMA-Factory/scripts/cal_ttl_ppl.py \
            --model_name_or_path ${checkpoint_path}/${model_base}/${base_token}/${domain}/${model_base}_${dataset1}_${dataset2}_${dataset3}_${lr}_seed42 \
