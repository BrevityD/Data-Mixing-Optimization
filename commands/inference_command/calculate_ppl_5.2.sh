...
eval_datasets=("tulu3_general_val" "tulu3_knowledge_recall_val" "tulu3_math_val" "tulu3_code_val" "tulu3_safety_val" "tulu3_precise_IF_val")
...
for seed in "${seeds[@]}"; do
    ...
    for eval_dataset in "${eval_datasets[@]}"; do 
        torchrun --nproc_per_node=1 /mbz/users/liyuan/LLaMA-Factory/scripts/cal_ppl.py \
