...
checkpoint_path="/mbz/users/liyuan/LLaMA-Factory/saves/data_mixing/orca"
# model_base="Llama-3.2-3B"
# model_base="Llama-3.1-8B"
model_base="Qwen2.5-1.5B"
base_token="660000"
experiment_result="/mbz/users/liyuan/LLaMA-Factory/results/data_mixing/orca"
...
for domain in "${domains[@]}"; do
    for size in "${sizes[@]}"; do
        ...
        for eval_dataset in "${eval_datasets[@]}"; do 
            ...
            --model_name_or_path ${checkpoint_path}/${model_base}/${base_token}/${domain}/${model_base}_${dataset1}_${dataset2}_${dataset3}_${dataset4}_${lr}_seed42 \
            --save_name ${experiment_result}/${model_base}/${base_token}/${domain}/ppl_${eval_dataset}_${model_base}_${dataset1}_${dataset2}_${dataset3}_${dataset4}.json \
            --batch_size 2 \
