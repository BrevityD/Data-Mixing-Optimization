...
dataset_instr="${base_token}_${domains[0]}_${base_token}_${model_base}_${domains[0]}_optim"
dataset_math="${base_token}_${domains[1]}_${base_token}_${model_base}_${domains[1]}_optim"
dataset_code="${base_token}_${domains[2]}_${base_token}_${model_base}_${domains[2]}_optim"


mkdir -p ${experiment_result}/${model_base}/${base_token}/optim

for eval_dataset in "${eval_datasets[@]}"; do 
    torchrun /mbz/users/liyuan/LLaMA-Factory/scripts/cal_ppl.py \
    --model_name_or_path ${checkpoint_path}/${model_base}/${base_token}/optim/${model_base}_${dataset_instr}_${dataset_math}_${dataset_code}_${lr}_seed42 \
    --save_name ${experiment_result}/${model_base}/${base_token}/optim/ppl_${eval_dataset}_${model_base}_${dataset_instr}_${dataset_math}_${dataset_code}.json \
    --batch_size 4 \
